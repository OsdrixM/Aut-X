                ...
                <table class="table table-dark">
                    ...
                    for(empleado o:us){
                          ...
                          out.println("<tr><td>"
                                ...
                                + "<a href='/aut/Administrador/empleados.jsp?ID="+o.getUsu()+"&NUM="+o.getTipo()+"&nom="+o.getNombre()+"&contra="+o.getContra()+"&corr="+o.getCorreo()+"'><img  alt='Responsive image'src='/aut/img/basura1.png'width='80' height='80'/></a></td><td>"
                                + "</tr>");
