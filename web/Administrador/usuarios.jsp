                ...
                <table class="table table-dark">
                    ...
                    for(usuarios o:us){
                          ...
                          out.println("<tr><td>"
                                ...
                                + "<a href='/aut/Administrador/"
                                + "usuarios.jsp?ID2="+o.getRela()+""
                                + "&ID="+o.getId()+"&NUM="+1+"&nom="+o.getNombre()+"&contra="+o.getContra()+"&corr="+o.getCorreo()+"'><img  alt='Responsive image'src='/aut/img/basura1.png'width='80' height='80'/></a></td><td></h5>"
                                + "</tr>");
